...
if (window.location.host.match("localhost")) {
    frontMenuButtonsFile = fetch('/Online-Grocery_Web-Programming/front-menu-buttons.json.php');
} else {
    frontMenuButtonsFile = fetch('/front-menu-buttons.json.php');
}
...
function action(data) {
    ...
    menu.innerHTML = "<label for='collapsible' id='menu-mobile' class='menu-label'>Menu</label>";
